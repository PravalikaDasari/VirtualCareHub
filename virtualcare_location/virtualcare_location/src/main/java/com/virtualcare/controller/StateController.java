...
//	public ResponseEntity<StateBean> getById(@PathVariable String state_code){
//		Optional<StateBean> getbyid=stateService.getById(state_code);
//		ResponseEntity<List<StateBean>> responseEntity = new ResponseEntity<>(state_code, HttpStatus.OK);
//		return responseEntity;
//		
//	}
}
